          ...
          <div class="tabs__box">
            ...
            >
              ...
              <div class="garanty" v-if="activeProductTab === 'Гарантия'">
                ...
                >
                  <div class="container">
                    <p class="garanty__subtitle">
                      Если при доставке товара, купленного в нашем
                      интернет-магазине, Вы обнаружили пересорт либо
                      некомплектность, Вам необходимо предпринять следующие
                      шаги:
                    </p>
                    <ol class="garanty__num-list">
                      <li>Сделать фотографию привезенного Вам товара.</li>
                      <li>
                        Сверить по паспорту изделия, каких именно комплектующих
                        или деталей не хватает.
                      </li>
                      <li>Написать нам письмо на электронную почту.</li>
                      <li>
                        В письме указать номер товарного чека, приложить к нему
                        фотографии и список некомплектных деталей.
                      </li>
                ...
                <topdrop-title
                  title="Поломка и ремонт"
                  titleClass="garanty__title"
                >
                  <div class="container">
                    <p class="garanty__subtitle">
                      Если у Вас произошла поломка изделия, купленного в нашем
                      интернет-магазине, Вам необходимо предпринять следующие
                      шаги:
                    </p>
                    <ol class="garanty__num-list">
                      <li>Сделать фото повреждения.</li>
                      <li>
                        Подготовить документы, подтверждающие факт покупки
                        (товарно-кассовый чек и паспорт изделия).
                      </li>
                      <li>
                        В свободной форме написать рекламацию (что сломалось, по
                        какой причине и т.д.).
                      </li>
                      <li>
                        Приложить товарно-кассовый чек, копию паспорта изделия
                        (если есть), гарантийного талона и т.д.
                      </li>
                      <li>Отправить рекламацию нам по электронной почте</li>
                      <li>
                        После получения вашего письма с Вами свяжется наш
                        менеджер и расскажет о необходимых дальнейших действиях.
                      </li>
                    </ol>
                  </div>
                </topdrop-title>
                <topdrop-title title="Возврат" titleClass="garanty__title">
                  <div class="container">
                    <ul class="garanty__list">
                      <li>
                        В соответствии со ст. 25 Закона Российской Федерации «О
                        защите прав потребителей» покупатель вправе обменять
                        непродовольственный товар надлежащего качества на
                        аналогичный за исключением перечня товаров, утвержденных
                        Правительством Российской Федерации, в том числе товаров
                        для профилактики и лечения заболеваний в домашних
                        условиях (предметов санитарии и гигиены из металла,
                        резины, текстиля и других материалов, инструментов,
                        приборов и медицинских аппаратур , предметов по уходу за
                        детьми), лекарственных препаратов, бытовой мебели
                        (мебельных гарнитуров и комплектов).
                      </li>
                      <li>
                        В соответствии с законодательством, возврат товара
                        возможен только в случае, если он не был в употреблении:
                        товар не собран, сохранен его товарный вид,
                        потребительские свойства, пломбы, фабричные ярлыки, а
                        также имеется товарный или кассовый чек, либо другой
                        подтверждающий оплату документ.
                      </li>
                      <li>
                        В любом случае, если товар вам не подходит, свяжитесь с
                        нашими менеджерами - вас проконсультируют о дальнейших
                        действиях.
                      </li>
                    </ul>
                  </div>
